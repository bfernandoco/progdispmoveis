...
public class MainActivity extends AppCompatActivity {
    ...
    private LocationManager locationManager; //HARDWARE DO GPS
    private LocationListener locationListener; //REGISTRO DE LOCALIZAÇÃO (PASSOS DO USUÁRIO)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse(String.format("geo:%f,%f?restaurantes", -23.5492, -46.5957));
